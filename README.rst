...
This is a git repository of the source files for the book The turner's companion
$b containing instructions in concentric, elliptic, and eccentric turning; also various plates of chucks, tools and instruments: and directions for using the eccentric cutter, drill, vertical cutter, and circular rest; with patterns, and instructions for working them. by Anonymous. This book is Public domain in the USA., see the LICENSE file for details. 
...
Technical details
=================
The main source file for this book will be a file with a name containing `70100` with a file extension (ex. `.txt`, `.rst`, `.tei`, `.tex`). Some books also contain generated ebooks, html versions, and images/figures from the text as image files. Eventually, there will be generated ebooks in the downloads area.
